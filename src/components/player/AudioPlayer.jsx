...
const AudioPlayer = () => {
  ...
  const handleToggleLike = async () => {
    if (currentSong) {
      await toggleLike(currentSong._id, currentSong);
    }
  };
  ...
  return (
    <div className="audio-player">
      ...
      <div className="player-left">
        ...
        <button 
          className={`player-button btn-like ${isLiked(currentSong._id) ? 'active' : ''}`} 
          onClick={handleToggleLike}
          title={isLiked(currentSong._id) ? 'Unlike' : 'Like'}
        >
          <svg viewBox="0 0 24 24" width="18" height="18">
            <path 
              fill={isLiked(currentSong._id) ? '#1db954' : 'currentColor'} 
              d={isLiked(currentSong._id) 
      ...
      <div className="player-right">
        ...
        <button 
          className={`player-button ${showQueue ? 'active' : ''}`} 
          title="Queue"
